        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="order-1 lg:order-2 space-y-6">
            <ScrollAnimation direction="left">
              ...
              {/* Quote/Missão */}
              <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-5 text-white shadow-lg mt-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {highlights.map((item, index) => (
            <ScrollAnimation key={index} direction="up" delay={index * 0.1}>
              <div 
                className="bg-white rounded-2xl p-6 shadow-lg border border-secondary/10 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group text-center h-full"
              >
